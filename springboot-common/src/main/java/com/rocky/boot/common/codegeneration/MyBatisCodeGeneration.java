package com.rocky.boot.common.codegeneration;
...
public class MyBatisCodeGeneration {
     ...
     */
    public static final String BASE_PACKAGE = "com.rocky.boot";
    /**
     * Model所在包
     */
    public static final String MODEL_PACKAGE = BASE_PACKAGE + ".codegeneration.temp.model";
    /**
     * Mapper所在包
     */
    public static final String MAPPER_PACKAGE = BASE_PACKAGE + ".codegeneration.temp.dao";
    /**
     * Mapper xml所在包
     */
    public static final String MAPPER_XML_PACKAGE = BASE_PACKAGE + ".codegeneration.temp.mapper";
    /**
     * Service所在包
     */
    public static final String SERVICE_PACKAGE = BASE_PACKAGE + ".codegeneration.temp.service";
    /**
     * ServiceImpl所在包
     */
     ...
     * Controller所在包
     */
    public static final String CONTROLLER_PACKAGE = BASE_PACKAGE + ".codegeneration.temp.controller";
    /**
     * Mapper插件基础接口的完全限定名
     */
     ...
     */
    private static final String JDBC_URL = "jdbc:mysql://localhost:3307/orders?useUnicode=true&characterEncoding=UTF-8";
     ...
     * 项目在硬盘上的基础路径
     */
    private static final String PROJECT_PATH = System.getProperty("user.dir") + "/springboot-commons/";
    /**
     * 模板位置
     */
