...
:: !!!!main class. replace it with youself.!!!!!
set MAIN_CLASS=com.rocky.boot.assembly.SpringbootAssemblyApplication
...
java -Xms324m -Xmx1024m  -classpath ..\conf;%LIB_JARS%   %MAIN_CLASS%
